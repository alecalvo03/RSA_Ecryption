...
section	.data
    bignum1     dq      33, 0, 0, 0, 0, 0, 0, 0;0xFFFFFFFFFFAFFFFF, 0xFFFFFBFFFFFFFFFF, 0, 0
    bignum2     dq      27, 0, 0, 0, 0, 0, 0, 0;0xFFFFFFFFFFFFFFCF, 0xFFFDFFFFFFFFFFFF, 0, 0
    ...
    test3       dq      0x1c09f91eab24b099, 0xc1973d12782e7ecc, 0, 0, 0, 0, 0, 0
    prueba      dq      0x05a6173cfb5b1dc0, 0x643195f051f90560, 0xa7fb8794a3762537, 0x7d6ca4a3cc900621, 0, 0, 0, 0
...
gcd:
    ...
    mov qword[copyD], gcdR
    mov qword[copyS], r10
    call copyvector
    
    mov qword[copyD], gcdT
    mov qword[copyS], r11
    call copyvector
...
gcdcmp:  ;Compare if gcdT == 0
    cmp qword[gcdT+rcx], 0
    jne gcdloop
    sub rcx, 8
    cmp rcx, 0
    jge gcdcmp
...
coprime:
    ...
    mov qword[randD], coprimeR
    call randbignum
    
    mov qword[clBignum], coprime1
    call clearbignum
    mov qword[coprime1], 1
...
coprimecmp:
    cmp qword[gcdR+rcx], 0
    jne coprimene
    sub rcx, 8
    cmp rcx, 8              ;Compare to 8 because 0 is compared above
    jge coprimecmp
    jmp coprimeret
    
coprimene:                  ;if gcd not equal to 1, add 1 to coprimeR
    mov qword[addD], coprimeR
    mov qword[addS], coprime1
    call bigadd
    jmp coprimeloop2
